...
export const ACCENT_COLOR = '#E31937';

// If your map has an offset please change this line
// issues #92 and #198
export const NEED_FIX_MAP = false;
export const MAIN_COLOR = ACCENT_COLOR;
export const PROVINCE_FILL_COLOR = ACCENT_COLOR;
export const COUNTRY_FILL_COLOR = '#333333';

// Static color constants
export const RUN_COLOR_LIGHT = ACCENT_COLOR;
export const RUN_COLOR_DARK = ACCENT_COLOR;
